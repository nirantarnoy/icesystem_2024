...
<div class="customerrequest-form">
    ...
    <?php if (!empty(\Yii::$app->session->getFlash('msg-success'))) { ?>
        <div class="alert alert-success">
            <?php echo \Yii::$app->session->getFlash('msg-success'); ?>
        </div>
    <?php } ?>
    ...
    <div class="row">
        ...
        <div class="col-lg-3">
            ...
            <input type="text" class="form-control" value="<?= $model->isNewRecord ? '' : \backend\models\Customer::findCode($model->customer_ref_id) ?>" readonly="readonly">
        </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-3">
            ...
            <input type="file" class="form-control" name="docfile[]" multiple accept="image/*">
        </div>
        <div class="col-lg-3">
            <label for="">รูปหน้าร้าน</label>
            <input type="file" class="form-control" name="shopfile[]" multiple accept="image/*">
        </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            ...
            <?php foreach($model_doc as $value):?>
                <a class="badge badge-primary" href="<?=\Yii::$app->getUrlManager()->getBaseUrl() . '/uploads/files/customerrequest/'. $value->doc_name ?>" target="_blank"><?= $value->doc_name ?></a>
            <?php endforeach;?>
            <?php endif;?>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <input type="checkbox"
                           ...
                           onclick="getPaymentType($(this))" value="1"> ขายสด เงินสด หรือ โอน บ/ช บจ.วรภัทร เลขที่ <u>764-3010880</u>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-1">
    ...
    <div class="row">
        <div class="col-lg-2">
            <?= $form->field($model, 'user_box')->widget(\toxor88\switchery\Switchery::className(), ['options' => ['label' => '', 'class' => 'form-control']])->label() ?>
        </div>
        <div class="col-lg-3">
        ...
        <div class="col-lg-12">
            ...
            <?php if($model_attach_select !=null):?>
                <?php foreach($model_attach_select as $valuey){
                    ...
                    ?>
                    <input type="checkbox" name="attatch_doc[]" <?= $loop_is_select ?> value="<?= $valuex->id ?>"> <?= $valuex->name ?>
            <?php endif;?>
                <?php endforeach;?>
            <?php endif;?>
        </div>
