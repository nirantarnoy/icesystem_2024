...
?>
    ...
    <div id="div1" class="page">
        ...
        <table style="width: 100%;border-left: 1px solid gray;border-right: 1px solid gray;border-bottom: 0;border-top: 0">
            <tr>
                <td rowspan="2" style="text-align: center;vertical-align: middle;width: 100%;border-bottom: none;"><h4><u>บันทึกการขาย
                            (เปิดร้าน)</u></h4></td>
                </td>
            </tr>
        </table>
            ...
            <tr>
                <td style="padding: 10px;">
                    ...
                    <table class="info-table">
                        ...
                        <tr>
                            <td><strong><u>ราคาขาย:</u></strong> <?= number_format($model->sale_price) ?></td>
                            ...
                            <td>
                                <table>
                                    <?php if ($model->payment_method_id == 1): ?>
                                        <tr>
                                            <td colspan="3">
                                                <input type="checkbox" <?= $model->payment_method_id == 1 ? 'checked' : '' ?> onclick="return false;">
                                                ขายสด เงินสด หรือ โอนผ่าน บ/ช. บจ.วรภัทร เลขที่ 764-3010880
                                            </td>
                                        </tr>
                                    <?php elseif ($model->payment_method_id == 2): ?>
                                        <tr>
                                            <td colspan="3">
                                                <input type="checkbox" <?= $model->payment_method_id == 2 ? 'checked' : '' ?> onclick="return false;">
                    ...
                    <table style="width: 100%">
                        ...
                        <tr>
                            <td style="text-align: center;">
                                ...
                                วันที่: <?= date('d-m-Y', strtotime($model->market_emp_date)) ?>
                            </td>
                            ...
                            <td style="text-align: center;border-left: 1px solid grey;">
                                ...
                                <br>วันที่: <?= date('d-m-Y', strtotime($model->market_emp_date)) ?>
                            </td>
                        </tr>
                    </table>
                </td>
        ...
        <table style="width: 100%;border-left: 1px solid gray;border-right: 1px solid gray;border-bottom: 1px solid gray;border-top: 0;font-size: 18px">
            <tr>
                <td style="padding: 10px;">
                    <div class="section"><strong><u>ขนาดบรรจุของถัง:</u></strong> 100 ลิตร บรรจุ 4 แพ็ค 200 ลิตร บรรจุ 8 แพ็ค 300 ลิตร บรรจุ 12 แพ็ค 500 ลิตร บรรจุ 18 แพ็ค</div>
                </td>
            </tr>
        </table>
        ...
        <table style="width: 100%;border-left: 1px solid gray;border-right: 1px solid gray;border-bottom: 1px solid gray;border-top: 0;font-size: 18px">
            ...
            <tr>
                <td colspan="6">
                    <div class="section" style="text-align: center"><strong><u>รายละเอียดการใช้ถัง</u></strong></div>
                </td>
            </tr>
            ...
            <tr>
                <td style="padding: 10px;">
                    <div class="section">
                        ...
                        <!--                        <span class="checkbox checked"></span> หน้าร้าน-->
                        <!--                        <span class="checkbox checked"></span> สำเนาบัตรประชาชนลูกค้า-->
                        <!--                        <span class="checkbox"></span> สัญญายืมถัง-->
                        <!--                        <span class="checkbox"></span> รูปถัง-->
                        <?php foreach ($attatch_doc_data as $valuex): ?>
                            ...
                            <input type="checkbox" name="attatch_doc[]" <?= $loop_is_select ?>
                                   value="<?= $valuex->id ?>" onclick="return false;"> <?= $valuex->name ?>
                        <?php endforeach; ?>
                    </div>
                </td>
            </tr>
