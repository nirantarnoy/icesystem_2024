...
<div id="div1">
    ...
    <table id="table-data">
        ...
        <tr style="font-weight: bold;">
            ...
            <?php endfor; ?>
            <td style="text-align: right;padding: 8px;border: 1px solid grey;background-color: mediumseagreen"><span onclick="sortTable(9)">รวม</span></td>
        </tr>
