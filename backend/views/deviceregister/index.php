...
/* @var $searchModel backend\models\DeviceregisterSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'อุปกรณ์ขายบนรถ';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="deviceregister-index">
    <?php Pjax::begin(); ?>
    <div class="row">
        <div class="col-lg-10">
            <p>
        ...
        <div class="col-lg-2" style="text-align: right">
            <form id="form-perpage" class="form-inline" action="<?= Url::to(['deviceregister/index'], true) ?>"
                  method="post">
          ...
          //  'device_token',
            ...
            [
                ...
                'value'=>function ($model) {
                      return \backend\models\Deviceregister::getRouteName($model->id);
                }
            ],
            //'status',
            //'created_at',
