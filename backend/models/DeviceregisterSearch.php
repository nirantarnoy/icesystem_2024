...
/**
 * DeviceregisterSearch represents the model behind the search form of `backend\models\Deviceregister`.
 */
class DeviceregisterSearch extends Deviceregister
{
    ...
    public function rules()
    {
        return [
            ...
            [['name', 'description', 'device_token', 'brand_name', 'model_name'], 'safe'],
            [['globalSearch'], 'string'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        if($this->globalSearch!='' || $this->globalSearch!=null){
            $query->orFilterWhere(['like', 'name', $this->globalSearch])
                ...
                ->orFilterWhere(['like', 'device_token', $this->globalSearch])
