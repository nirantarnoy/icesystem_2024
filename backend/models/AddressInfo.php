...
//    }
    ...
    {
        $c_district = \common\models\AddressInfo::find()->where(['party_id'=>$id,'party_type_id'=>$type,'address_type_id'=>1])->one();
        if ($c_district){
    ...
    public static function findDistrictId2($id, $type)
    {
        $c_district = \common\models\AddressInfo::find()->where(['party_id'=>$id,'party_type_id'=>$type,'address_type_id'=>2])->one();
        if ($c_district){
            return $c_district != null ? $c_district->district_id : 0;
        }else{
            return 0;
    ...
    public static function findAmphurId2($id,$type)
    {
        $c_district = \common\models\AddressInfo::find()->where(['party_id'=>$id,'party_type_id'=>$type,'address_type_id'=>2])->one();
        if ($c_district){
            return $c_district != null ? $c_district->city_id : 0;
    ...
    {
        $c_province = \common\models\AddressInfo::find()->where(['party_id'=>$id,'party_type_id'=>$type,'address_type_id'=>1])->one();
        if ($c_province){
    ...
    public static function findProvinceId2($id,$type)
    {
        $c_province = \common\models\AddressInfo::find()->where(['party_id'=>$id,'party_type_id'=>$type,'address_type_id'=>2])->one();
        if ($c_province){
            return $c_province != null ? $c_province->province_id : 0;
        }else{
            return 0;
