            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                ...
                <li class="nav-item has-treeview has-sub">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <?php endif; ?>
                        <?php //if (\Yii::$app->user->can('product/print')): ?>
                            <li class="nav-item">
                                <a href="index.php?r=prodrecbalanceqty/index" class="nav-link prodrecbalanceqty">
                                    <i class="far fa-circlez nav-icon"></i>
                                    <p>
                                        รายงานคงเหลือตั๋วผลิต
                                    </p>
                                </a>
                            </li>
                        <?php //endif; ?>
                ...
                <li class="nav-item has-treeview has-sub">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <?php endif;?>
                        <?php  if(\Yii::$app->user->can('pos/printsummarybp')): ?>
                            <li class="nav-item">
                                <a href="index.php?r=pos/printsummarybp" class="nav-link pos">
                                    <i class="far fa-circlez nav-icon"></i>
