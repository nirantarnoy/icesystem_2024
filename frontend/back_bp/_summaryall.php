    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <form id="form-edit-summary" action="<?= \yii\helpers\Url::to(['adminreport/editsummary'], true) ?>"
                ...
                <input type="hidden" id="edit-shift-num" name="edit_shift_num" value="<?= $to_date ?>">
...
function editshiftdata(e){
    ...
    var t_edit_shift_id = e.attr("data-shift-id");
   // alert(t_edit_shift_id);
    if(t_date !='' && t_shift != ''){
        ...
        $("#edit-shift-num").val(t_edit_shift_id);
