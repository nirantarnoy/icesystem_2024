                ...
                <table style="width: 100%">
                    <tr>
                        ...
                        <td>
                            <table style="width: 100%;">
                                <tr>
                                    <td style="width: 75%;border-bottom: 1px dashed grey;border-top: none;border-left: none;border-right: none"></td>
                                    <td style="width: 5%;border: 1px solid #000"></td>
                                    <td style="width: 10%;text-align: center;border: 1px solid #000"><b>ระบบ</b></td>
                                    <td style="width: 10%;text-align: center;border: 1px solid #000"><b>นับจริง</b></td>
                                </tr>
                                <tr>
                                    <td style="padding:10px;border-bottom: 1px dashed grey;border-top: none;border-left: none;border-right: none"></td>
                                    <td style="border: 1px solid #000;padding:10px;text-align: right;"><b>ตั๋วจ่าย</b></td>
                                    <td style="border: 1px solid #000;padding:10px;"></td>
                                    <td style="border: 1px solid #000;padding:10px;"></td>
                                </tr>
                                <tr>
                                    <td style="padding:10px;border-bottom: 1px dashed grey;border-top: none;border-left: none;border-right: none"></td>
                                    <td style="border: 1px solid #000;padding:10px;text-align: right;"><b>Cancel/Re</b></td>
                                    <td style="border: 1px solid #000;padding:10px;"></td>
                                    <td style="border: 1px solid #000;padding:10px;"></td>
                                </tr>
                                <tr>
                                    <td style="padding:10px;border-bottom: 1px dashed grey;border-top: none;border-left: none;border-right: none"></td>
                                    <td style="border: 1px solid #000;padding:10px;text-align: right;"><b>รวม</b></td>
                                    <td style="border: 1px solid #000;padding:10px;"></td>
                                    <td style="border: 1px solid #000;padding:10px;"></td>
                                </tr>
                                <tr>
                                    <td style="padding:10px;border-bottom: 1px dashed grey;border-top: none;border-left: none;border-right: none"></td>
                                    <td style="border: 1px solid #000;padding:10px;text-align: right;"><b>+/-</b></td>
                                    <td style="border: 1px solid #000;padding:10px;"></td>
                                    <td style="border: 1px solid #000;padding:10px;"></td>
                                </tr>
...
function findSecondUsername($user_id){
   ...
   // $model = \common\models\LoginLogCal::find()->where(['user_id' => $user_id,'status'=>1])->andFilterWhere(['date(login_date)'=>date('Y-m-d')])->one();
    $model = \common\models\LoginLogCal::find()->where(['user_id' => $user_id])->andFilterWhere(['date(login_date)'=>date('Y-m-d')])->all();
    if($model){
        foreach ($model as $value) {
            $modelx = \common\models\LoginUserRef::find()->where(['login_log_cal_id' => $value->id])->all();
            if($modelx){
                foreach ($modelx as $valuex) {
                    $name  = $name. \backend\models\User::findName($valuex->user_id).",";
                }
            }
        }
