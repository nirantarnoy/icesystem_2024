...
?>
                    ...
                    <?php for ($i = 0; $i <= count($find_order) - 1; $i++): ?>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="text" <?php echo $bg_col?> class="form-control customer-ref-no" name="delivery_no[]" value="<?=$find_order[$i]['customer_ref_no']?>">
                            </td>
    ...
    <table width="100%" class="table-title">
        <td style="text-align: right">
            <button id="btn-print" class="btn btn-warning" onclick="printContent('div1')">พิมพ์ + บันทึก</button>
            <button class="btn btn-success btn-save-update">บันทึก</button>
        </td>
    </table>
    </form>
    <br/>
...
function printContent(el)
      {
         ...
         //     alert($(this).find(".customer-ref-no").val());
         //   
         // });
