                ...
                'rules' => [
                    ...
                    [
                        'actions' => [
                            ...
                            , 'finduserdate', 'editsaleclose', 'createscreenshort', 'print2', 'calcloseshift', 'closesaletest','closesaletestnew','printtestnew','printtestnewdo','printsummarycarnky','printsummaryposnky', 'sales-by-route'
                        ],
                        'allow' => true,
                        'roles' => ['@'],
                    ],
