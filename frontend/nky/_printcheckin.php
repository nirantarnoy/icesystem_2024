...
<head>
    ...
    <style>
        ...
        /* Print styles - ซ่อน elements ที่มี class no-print เมื่อปริ้น */
        @media print {
            .no-print {
...
<table class="table-title" id="table-data" style="width: 100%">
    <tr>
        ...
        <td style="text-align: center;border: 1px solid gray"><b>เหตุการณ์</b></td>
        <td style="text-align: center;border: 1px solid gray;width: 20%"><b>รูปภาพ</b></td>
        <td class="no-print" style="text-align: center;border: 1px solid gray;width: 20%"><b>ลิงค์ดาวน์โหลด</b></td>
    </tr>
    <?php $i = 0; ?>
    <?php foreach ($model_asset_check as $value): ?>
        ...
        if($value->reason_id == 1){
            $reason_name = "ตู้เต็ม";
        }else if($value->reason_id == 2){
            $reason_name = "ลงปกติ";
        }else if($value->reason_id == 3){
            $reason_name = "ตู้เสีย";
        }
        ?>
        <tr>
            ...
            <td style="text-align: center;border: 1px solid gray;width: 20%">
                ...
                <img src="<?=\Yii::$app->urlManagerFrontend->getBaseUrl()?>/uploads/assetcheck/<?=$photolist[$x]?>" alt="" width="100%">
                <?php endfor;?>
            </td>
            <td class="no-print" style="text-align: center;border: 1px solid gray;width: 20%">
                <a class="no-print" href="<?='http://141.98.19.240'.\Yii::$app->urlManagerFrontend->getBaseUrl()?>/uploads/assetcheck/<?=$photolist[0]?>" target="_blank"><?='http://141.98.19.240'.\Yii::$app->urlManagerFrontend->getBaseUrl()?>/uploads/assetcheck/<?=$photolist[0]?></a>
            </td>
        </tr>
    <?php endforeach; ?>
</table>
