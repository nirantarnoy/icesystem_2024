                ...
                <li class="nav-item has-treeview has-sub">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <?php if (\Yii::$app->user->can('adminreport/printcarcj')): ?>
                            <li class="nav-item">
                                <a href="index.php?r=adminreport/printcarcj" class="nav-link pos">
                                    <i class="far fa-circlez nav-icon"></i>
                                    <p>ยอดขาย CJ</p>
                                </a>
                            </li>
                        <?php endif;?>
                        <?php if (\Yii::$app->user->can('adminreport/printcarlotus')): ?>
                            <li class="nav-item">
                                <a href="index.php?r=adminreport/printcarlotus" class="nav-link adminreport">
                                    <i class="far fa-circlez nav-icon"></i>
                                    <p>ยอดขาย Lotus</p>
                                </a>
                            </li>
                        ...
                        <?php if (\Yii::$app->user->can('saleroutesummary/index')): ?>
                            <li class="nav-item">
                                <a href="index.php?r=saleroutesummary/index" class="nav-link saleroutesummary">
                                    <i class="far fa-circlez nav-icon"></i>
                                    <p>รายงานขายลูกค้าตามสายส่ง</p>
                                </a>
                            </li>
                        <?php endif;?>
                        <?php //if (\Yii::$app->user->can('saleroutesummary/index')): ?>
                        <li class="nav-item">
                            <a href="index.php?r=adminreport/printcarnotrans" class="nav-link adminreport">
                                <i class="far fa-circlez nav-icon"></i>
                                <p>รายงาน 60 วัน</p>
                            </a>
                        </li>
...
<!--                        </li>-->
                ...
                <?php if (\Yii::$app->user->can('customerrequest/index')): ?>
                    <li class="nav-item has-treeview has-sub">
                        <a href="#" class="nav-link">
                            <i class="nav-icon fas fa-money-bill"></i>
                            <p>
                        ...
                        <ul class="nav nav-treeview">
                            <?php if (\Yii::$app->user->can('customerrequest/index')): ?>
                                <li class="nav-item">
                                    <a href="index.php?r=customerrequest" class="nav-link customerrequest">
                                        <i class="far fa-circlez nav-icon"></i>
                                        <p>เปิดร้านค้า</p>
                                    </a>
                                </li>
