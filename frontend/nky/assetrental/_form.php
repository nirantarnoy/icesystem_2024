...
?>
    ...
    <div class="assetrental-form">
        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                <?php $model->use_from = $model->isNewRecord ? date('d-m-Y') : date('d-m-Y',strtotime($model->use_from)); ?>
            ...
            <div class="col-lg-3">
                <?php $model->use_to = $model->isNewRecord ? date('d-m-Y') : date('d-m-Y',strtotime($model->use_to)); ?>
