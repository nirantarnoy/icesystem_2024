...
<div class="customerrequest-form">
    ...
    <div class="row">
        ...
        <div class="col-lg-3">
            ...
            <input type="file" class="form-control" name="docfile[]" required multiple accept="image/*">
        </div>
        <div class="col-lg-3">
            <label for="">รูปหน้าร้าน</label>
            <input type="file" class="form-control" name="shopfile[]" required multiple accept="image/*">
        </div>
