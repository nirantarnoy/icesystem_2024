...
//        $line_token = 'NY1xHWO4Qa6EWGA25AKuQVeHwSwpeTEPpCGE3pYB5qT';
         $line_token = '6aeDRpOSzHqJeLA9OYiy8PE7Cq38tJ7ORl8qZvsDaQM'; //NCS
...
//        $line_token = trim($b_token);
        ...
        // $message .= 'สามารถดูรายละเอียดได้ที่ http://103.253.73.108/icesystem/backend/web/index.php?r=dailysum/indexnew' . "\n"; // nky
        $message .= 'สามารถดูรายละเอียดได้ที่ http://141.98.16.4/icesystemncs/backend/web/index.php?r=dailysum/indexnew' . "\n"; // bkt
...
//        }
        ...
        $model = \common\models\QueryCustomerPrice::find()->where(['cus_id' => 1])->all(); //71 is สดหน้าบ้าน dindang
        if ($model) {
            foreach ($model as $value) {
