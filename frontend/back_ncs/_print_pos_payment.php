                                        ...
                                        <table style="font-size: 14px;">
                                            ...
                                            <?php for ($k = 0; $k <= count($payline) - 1; $k++): ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php //if ($payline[$k]['slip_doc'] != null || $payline[$k]['slip_doc'] != ''): ?>
                                                            <a href="<?=\Yii::$app->getUrlManager()->baseUrl . '/uploads/files/receive/' . $payline[$k]['slip_doc']?>" target="_blank" style="color: red">view</a>
                                                        <?php //endif; ?>
                                                    </td>
                                                </tr>
                                            <?php endfor; ?>
                                    ...
                                    <table style="font-size: 14px;">
                                        ...
                                        <?php for ($k = 0; $k <= count($payline) - 1; $k++): ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $payline[$k]['pay_channel'] ?></td>
                                                <td>
                                                    <?php if (($payline[$k]['slip_doc'] != null || $payline[$k]['slip_doc'] != '') && $k==0): ?>
                                                        <a href="<?=\Yii::$app->getUrlManager()->baseUrl . '/uploads/files/receive/' . $payline[$k]['slip_doc']?>" target="_blank" style="color: red">view</a>
                                                    <?php endif; ?>
                                                </td>
                                            </tr>
...
function getPaymentLine($payment_id, $company_id, $branch_id)
{
    ...
    $data = [];
    $sql = "SELECT t1.order_id,t1.payment_amount,t2.crated_by,t1.payment_channel_id,t1.doc,t1.payment_method_id,t2.slip_doc
