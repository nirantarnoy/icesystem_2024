...
class DeliveryRoute extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
           // [['code'],'unique'],
            [['company_id', 'branch_id', 'created_at', 'updated_at', 'created_by', 'updated_by','type_id','status','is_other_branch','is_dup_login','is_cal_commission'], 'integer'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'is_cal_commission' => Yii::t('app', 'คํานวณค่าคอมมิชชั่น'),
