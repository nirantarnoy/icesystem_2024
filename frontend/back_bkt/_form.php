...
$is_adpang = false;
if (!empty(\Yii::$app->user->identity->username) && \Yii::$app->user->identity->username == 'adpang') {
    $is_adpang = true;
}
...
<div class="car-form">
    ...
    <div class="row">
        ...
        <div class="col-lg-10">
            <?= $form->field($model, 'code')->textInput(['maxlength' => true, 'readonly' => !$is_adpang]) ?>
        </div>
        <div class="col-lg-1"></div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-1"></div>
        <div class="col-lg-10">
            <?= $form->field($model, 'name')->textInput(['maxlength' => true, 'readonly' => !$is_adpang]) ?>
        </div>
        <div class="col-lg-1"></div>
    </div>
    <div class="row">
        <div class="col-lg-1"></div>
        <div class="col-lg-10">
            <?= $form->field($model, 'description')->textarea(['maxlength' => true, 'readonly' => !$is_adpang]) ?>
        </div>
        <div class="col-lg-1"></div>
    </div>
    <div class="row">
    ...
    <div class="row">
        <div class="col-lg-1"></div>
        <div class="col-lg-5">
            <?= $form->field($model, 'plate_number')->textInput(['maxlength' => true, 'readonly' => !$is_adpang]) ?>
        </div>
        <div class="col-lg-5">
        ...
        <div class="col-lg-10">
            ...
            <?php else: ?>
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <?= $form->field($model, 'photo')->fileInput(['maxlength' => true, 'disabled' => !$is_adpang]) ?>
                    </div>
                    <div class="col-lg-4"></div>
                    <div class="col-lg-4"></div>
                </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-10">
            ...
            <?php echo $form->field($model, 'status')->widget(\toxor88\switchery\Switchery::className(), ['options' => ['label' => '', 'class' => 'form-control', 'disabled' => !$is_adpang]])->label(false) ?>
        </div>
        <div class="col-lg-1"></div>
    </div>
    <br>
