...
$model_cj = null;
$sql = "SELECT customer_code,customer_name,route_code,branch_no FROM query_order_amazon_summary";
...
$model_cj_data = null;
$sql = "SELECT * FROM query_order_amazon_summary";
$sql .= " WHERE (date(order_date) BETWEEN '" . $from_date . "' AND '" . $to_date . "')";
if($route_id!=null){
...
<div class="row">
    <div class="col-lg-9">
        <form action="<?= \yii\helpers\Url::to(['adminreport/printcaramazon'], true) ?>" method="post" id="form-search">
...
<div id="div1">
    <table class="table-header" width="100%">
        <tr>
            <td style="text-align: center; font-size: 20px; font-weight: bold">รายงานจำนวนขายสายส่ง AZ</td>
        </tr>
    </table>
    <br>
    <table class="table-header" width="100%">
    ...
    <table id="table-data">
        ...
        <tr style="font-weight: bold;">
            ...
            <td style="text-align: center;padding: 8px;border: 1px solid grey;cursor: pointer;" onclick="sortTable(2)">ชื่อลูกค้า <i class="fa fa-sort"></i></td>
            <td style="text-align: center;padding: 8px;border: 1px solid grey;cursor: pointer;" onclick="sortTable(3)">สายส่ง <i class="fa fa-sort"></i></td>
...
function sortTable(n) {
  ...
  for (var r = 1; r < rows.length - 1; r++) {
     if(rows[r].cells[0].innerHTML != "" && rows[r].cells[3].innerHTML != "รวม"){
        rows[r].cells[0].innerHTML = idx++;
     }
  }
}
